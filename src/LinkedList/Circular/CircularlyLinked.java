...
public class CircularlyLinked<T> {
    ...
    public Node<T> search(T searchData) throws LinkedList.OneWayLinked.LinkedList.EmptyListException {
        //Returned value set to null in case element does not exist

        if (this.isEmpty()) {
            throw new LinkedList.OneWayLinked.LinkedList.EmptyListException("Tried searching an empty list");
        }
        Node<T> curNode = head;
